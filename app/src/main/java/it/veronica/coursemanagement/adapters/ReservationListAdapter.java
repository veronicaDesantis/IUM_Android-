...
public class ReservationListAdapter extends ArrayAdapter<Reservation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        date.setText(reservation.getDisponibility().getDatetime());
        slot.setText(reservation.getDisponibility().getSlotTime());
        TextView course = convertView.findViewById(R.id.course);
        course.setText(reservation.getDisponibility().getCourse().getTitle());
